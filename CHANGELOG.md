...
## [2.3.0] - 2026-04-16
### Added
- Add support for linting `.sh` and `Dockerfile` files
- Add `sos-prettier` command for linting non-JS projects (using `npx sos-prettier --package=@signageos/codestyle`)

### Fixed
- Remove `docker-compose.yml` from ignored files

## [2.2.1] - 2026-04-15
### Fixed
- Allow duplicate keys in `package.json` to allow multiple "//" keys for comments

## [2.2.0] - 2026-04-09
### Added
- Lint .yaml, .yml, .html and .md files with eslint

## [2.1.2] - 2026-04-07
### Fixed
- Fix eslint.config.d.mjs type definition
